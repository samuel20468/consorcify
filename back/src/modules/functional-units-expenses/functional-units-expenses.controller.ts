...
export class FunctionalUnitsExpensesController {
  ...
  @Post()
  async create(@Body() newFunctionalUnitsExpenseDto: CreateFunctionalUnitsExpenseDto): Promise<FunctionalUnitsExpense> {
    return await this.functionalUnitsExpensesService.create(newFunctionalUnitsExpenseDto);
  }
