    ...
    return (
        <div className="flex w-full h-screen gap-3 text-white">
            <ContainerDashboard className="flex flex-col w-full p-5">
                ...
                <div className="flex flex-col items-center justify-around w-[60%] p-10 text-black border rounded-[50px] bg-[#dadada]">
                    <div className="flex w-full justify-start items-center rounded-xl mb-[3%]">
                        <img
                            src={admin?.picture}
                            alt={admin?.name}
                            className="rounded-[40px] w-[25%] shadow-md shadow-gray-500 ml-[12%]"
                        />
                        <h1 className="text-4xl ml-[3%]">{admin?.name}</h1>
                    </div>
                    <div className="flex flex-col w-3/4 gap-2">
                        <p className="px-5 py-3  rounded-[50px] bg-[#e5e7eb] shadow text-fondo border-fondo">
                            CUIT: {admin?.cuit}
                        </p>
                        <p className="px-5 py-3  rounded-[50px] bg-[#e5e7eb] shadow text-fondo border-fondo">
                        ...
                        <p className="px-5 py-3  rounded-[50px] bg-[#e5e7eb] shadow text-fondo border-fondo">
                            SITUACIÓN TRIBUTARIA: {admin?.sat}
                        </p>
                        <p className="px-5 py-3  rounded-[50px] bg-[#e5e7eb] shadow text-fondo border-fondo mb-5">
                            MATRÍCULA RPA: {admin?.rpa}
                        </p>
                    </div>
