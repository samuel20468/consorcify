        ...
        <div className="w-full h-[50%] border rounded-[40px] flex flex-col items-center justify-center p-3">
          ...
          <div className="flex flex-col border w-[50%] p-5 gap-2 rounded-[40px] px-10">
            <div className="flex w-full justify-evenly">
              <p className="flex justify-start w-full">Saldo anterior:</p>
              <p>${expense?.previous_balance}</p>
            </div>
            <div className="flex w-full justify-evenly">
              <p className="flex justify-start w-full">Intereses totales:</p>
              <p>${expense?.interests}</p>
            </div>
            <div className="flex w-full justify-evenly">
              <p className="flex justify-start w-full">Gastos del mes:</p>
          ...
          <div className="w-[50%] py-2 flex justify-evenly">
            ...
            <Link href="">
              <Button className="w-32 py-2 rounded-[40px]" onClick={handlePay}>
                Pagar
              </Button>
            </Link>
          </div>
