    ...
    const fetchConsortium = async () => {
      if (update) {
        try {
          ...
          if (data.c_admin !== null && typeof data.c_admin === "object") {
          ...
          Swal.fire({
            ...
            if (res.isConfirmed) {
              if (data?.roles?.[0] == "superadmin") {
                ...
                router.push(`/dashboard/admin/consortiums/${params.id}`);
              }
            }
          });
        }
        ...
        if (response?.ok) {
          Swal.fire({
            ...
            if (res.isConfirmed) {
              ...
              if (data?.roles?.[0] == "superadmin") {
                router.push(`/dashboard/superadmin/consorcios/All/${dato.id}`);
              } else {
                router.push(`/dashboard/admin/consortiums/${dato.id}`);
              }
            }
          });
        }
    ...
    <div className="w-full h-auto p-4 text-white border rounded-[40px]">
      ...
      <form className="mx-10 my-5" autoComplete="off" onSubmit={handleSubmit}>
        <div className="flex flex-row gap-4">
          ...
          <div className="flex flex-col w-1/4">
            ...
            <Input
              ...
              disabled={update}
            />
            {consortiumRegisterError.cuit && consortiumRegister.cuit && (
        ...
        <div className="flex flex-row gap-4">
          ...
          <div className="flex flex-col w-1/4">
            <Label htmlFor="category">Categoría del edificio:</Label>
            <Input
              id="category"
              name="category"
              type="number"
        ...
        <div className="flex flex-row gap-4">
          <div className="flex flex-col w-1/4">
            ...
            <Input
              ...
              placeholder="5"
              value={
                consortiumRegister.floors == 0 ? "" : consortiumRegister.floors
              }
              onChange={handleChange}
            />
          </div>
          <div className="flex flex-col w-1/4">
            ...
            <Input
              ...
              type="number"
              placeholder="17"
              value={consortiumRegister.ufs == 0 ? "" : consortiumRegister.ufs}
              onChange={handleChange}
            />
          </div>
          <div className="flex flex-col w-1/4">
          ...
          <div className="flex flex-col w-1/4">
            <Label htmlFor="first_due_day">Vencimiento de expensas:</Label>
            <Input
              id="first_due_day"
              name="first_due_day"
              type="number"
