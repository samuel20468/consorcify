      ...
      <div className="flex flex-col lg:flex-row w-screen font-sans h-screen">
        <div className="col-izquierda flex flex-col space-y-6 w-[45vw] px-[5rem] border-r border-white">
          ...
          <p className="text-lg text-[#696969]">
            Nos encantaría saber de usted. Nuestro amigable equipo siempre está
            aquí para charlar.
          </p>
          <div className="flex flex-col space-y-10">
            ...
            <div>
              <Link href="/" className="my-3 text-[#696969] text-2xl hover:text-white duration-500 cursor-pointer">
                Volver al inicio
              </Link>
            </div>
          </div>
        ...
        <div className="flex flex-col space-y-6 w-full text-white p-8 rounded-lg  justify-center items-center imagen">
          <h1 className="text-5xl font-bold">¡Empieza tu viaje con nosotros!</h1>
          <p className="text-lg">
            Regístrate para empezar a disfrutar de nuestros servicios.
          </p>
          <form className="flex flex-col w-[27vw]" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between w-full h-10 my-1 rounded-md">
              ...
              />
              <button type="button" className="w-8 p-1" onClick={handleLock}>
            ...
            <div className="mt-10">
              <button type="submit" className="w-full py-2 text-black rounded-[50px] shadow-md bg-neutral-50 hover:bg-input hover:text-white disabled:pointer-events-none duration-500">Registrase</button>
            </div>
          </form>
