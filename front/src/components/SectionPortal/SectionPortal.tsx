...
const SectionPortal = () => {
    return (
        <div className="flex flex-col items-center w-[90%] gap-4 my-10">
            <Link href="portal/suppliers" className="w-1/3 mb-5">
                <Button className="flex flex-col justify-center items-center rounded-[40px] w-full py-6">
            ...
            <div className="flex items-center w-full gap-4">
                ...
                <div className="flex flex-col items-center justify-center w-2/3">
                    ...
                    <h1 className="mt-1 text-xl">Reclamos</h1>
                    <p className="text-center font-extralight">
                        Tendras un lugar para poder realizar cualquier tipo de
                        reclamo.
                    </p>
                </div>
            </div>
